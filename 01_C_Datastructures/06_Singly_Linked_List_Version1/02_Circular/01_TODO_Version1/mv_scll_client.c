...
int main(void)
{
	...
	mv_scll_insert_before(plist, (data_t)(long long)(1235), (data_t)(long long)(1234), compare_data);
	mv_scll_insert_before(plist, (data_t)(long long)(9999), (data_t)(long long)(5678), compare_data);
	mv_scll_insert_before(plist, (data_t)(long long)(2323), (data_t)(long long)(9087), compare_data);
	mv_scll_insert_before(plist, (data_t)(long long)(5555), (data_t)(long long)(6534), compare_data);
	mv_scll_insert_before(plist, (data_t)(long long)(8768), (data_t)(long long)(2190), compare_data);

	fprintf(stdout, "After List insert Before:\n");
	mv_scll_print_forward(plist, print_long_data);

	mv_scll_insert_after(plist, (data_t)(long long)(2222), (data_t)(long long)(1235), compare_data);
	mv_scll_insert_after(plist, (data_t)(long long)(1111), (data_t)(long long)(9999), compare_data);
	mv_scll_insert_after(plist, (data_t)(long long)(6566), (data_t)(long long)(2323), compare_data);
	mv_scll_insert_after(plist, (data_t)(long long)(82), (data_t)(long long)(27), compare_data);
	mv_scll_insert_after(plist, (data_t)(long long)(2121), (data_t)(long long)(120), compare_data);
